...
## Prompt
Actúa como un desarrollador experto en Flutter, diseñador UI/UX profesional y arquitecto de software, y diseña un plan completo para una aplicación multiplataforma tipo Amazon llamada “Amazon Compras”, utilizando Firebase como backend y Antigravity como herramienta de diseño visual, sin generar código al inicio, sino estructurando un documento detallado que incluya objetivo, arquitectura, fases de desarrollo y diseño profesional; la app debe permitir registro, login, exploración de productos, carrito, compras y gestión de pedidos, integrando un sistema visual moderno basado en la paleta de colores: azul oscuro #131921, gris claro #F2F2F2, blanco #FFFFFF, negro #000000, negro 54% #0000008A, negro 12% #0000001F, negro 5% #0000000D, blanco 70% #FFFFFFB3, naranja #FFA500, gris #9E9E9E y transparente #00000000, además de aplicar degradados en header (#131921 a #000000), botones (#FFA500 a #FFB84D) y fondos (#F2F2F2 a #FFFFFF), describiendo componentes como AppBar con buscador, BottomNavigationBar, tarjetas de producto con imagen, precio y rating, botones modernos con animaciones, barra de búsqueda, carrito y checkout, incluyendo sistema de diseño con espaciado de 8px, tipografía jerárquica y uso de sombras, así como principios UX con microinteracciones, feedback visual y navegación intuitiva; también debe explicar el uso de Antigravity para crear interfaces, exportarlas e integrarlas en Flutter, la configuración de Firebase (Authentication, Firestore, Storage), el uso de un modelo de datos basado en entidades como CLIENTE, DIRECCION, METODO_PAGO, PRODUCTO, CATEGORIA, VENDEDOR, PEDIDO, ITEM_PEDIDO, PAGO, ENVIO, TRANSPORTISTA y RESEÑA, una arquitectura tipo MVVM o Clean Architecture con Provider para manejo de estado, dependencias necesarias, fases de desarrollo (configuración, diseño UI, autenticación, catálogo, carrito, checkout y pruebas), flujo completo de la aplicación (splash, login, home, producto, carrito, pago y confirmación), y como resultado final una aplicación moderna, profesional, intuitiva y escalable similar a Amazon.
